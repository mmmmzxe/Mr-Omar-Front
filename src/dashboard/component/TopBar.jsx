...
const TopBar = () => {
  ...
  return (
    <div className="w-full bg-[var(--secondary)] md:sticky md:top-0 z-50" ref={headerRef}>
      ...
      <div />
        ...
        {/* SearchBar */}
        <div className="md:inline-flex max-w-24 ml-2 2xl:max-w-xl md:max-w-60 lg:max-w-96 lg:ml-0 md:ml-2 w-full relative">
          <input
            type="text"
            placeholder="بحث ....."
        ...
        {/* Menubar */}
        <div className="flex items-center md:gap-x-6 gap-x-3 text-2xl lg:ml-4 2xl:ml-0 ml-0">
          <Link to={"/profile"}>
